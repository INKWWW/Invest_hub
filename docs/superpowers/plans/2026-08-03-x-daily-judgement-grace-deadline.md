...
- [x] **Step 1: Write and run the failing Reader component assertion**
...
- [x] **Step 2: Implement the smallest safe projection and rendering change**
...
- [x] **Step 3: Verify, record and publish**
