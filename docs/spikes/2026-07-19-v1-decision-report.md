...
| 10 | 多来源、权限、恢复、阅读测试 | pass | pgTAP 114、控制面 49、Worker 60、V1 E2E 3 个测试均通过。 |
| 11 | 敏感资料不进入 Git、日志或页面 | conditional | 仓库脱敏检查、DTO allowlist、部署前后受保护配置和本地 evidence 权限复核通过；仍缺一次面向部署日志的独立审阅。 |
