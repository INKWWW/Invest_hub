...
│   ├── 2026-07-18-v0.md
│   ├── 2026-07-19-v1.md
│   └── 2026-07-22-v1.1-discord-windowed-collection.md
└── spikes/
...
- [V1.1 Engineering Journal（作者 selector 修订 migration 已应用；控制面部署与真实内容验收/launchd 待执行）](engineering-journal/2026-07-22-v1.1-discord-windowed-collection.md)
