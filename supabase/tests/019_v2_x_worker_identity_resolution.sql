...
values
  ...
  ('00000000-0000-0000-0000-000000019013', 'fixture_queued', 'X Identity Queued', 'pending'),
  ('00000000-0000-0000-0000-000000019014', 'fixture_leased', 'X Identity Leased', 'pending'),
  ('00000000-0000-0000-0000-000000019015', 'fixture_retryable', 'X Identity Retryable', 'pending');
...
select is(
  (public.resolve_x_source_identity('00000000-0000-0000-0000-000000019011', '00000000-0000-0000-0000-000000019001', 'v2-identity', 'fixture_handle')->>'idempotent'),
  'true',
  'the already resolved matching identity returns an idempotent receipt'
);
