...
select is(
  public.persist_worker_execution(
    ...
    '{
      ...
      "attempt":1,
      "source_id":"discord-persistence-test",
      "raw_messages":[{"external_message_id":"message-1","occurred_at":"2099-01-01T00:00:00Z","local_raw_ref":"local://v0/raw/recapture-message-1.json","payload_hash":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","retention_expires_at":"2100-01-01T00:00:00Z"}],
      "canonical_messages":[{"external_message_id":"message-1","occurred_at":"2099-01-01T00:00:00Z","author_display":"fixture-author","content":"fixture content","has_unparsed_media":false,"metadata":{}}],
  ...
  'true',
  'a recapture with a changed raw transport hash retains the existing raw evidence reference'
);
